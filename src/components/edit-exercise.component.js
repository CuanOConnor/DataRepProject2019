...
// constructor
  ...
  componentDidMount() {
    ...
    // checks response then maps user
  ...
  // on submitting saves data in, and does a post to server
  onSubmit(e) {
    e.preventDefault();
  ...
  // form render for editing exercise
  render() {
    return (
    <div className="EditExerciseContainer">
      <h3>Edit Exercise</h3>
      <form onSubmit={this.onSubmit}>
        ...
        <div className="form-group">
          <input type="submit" value="Edit Exercise" className="button" />
        </div>
      </form>
    </div>
    )
